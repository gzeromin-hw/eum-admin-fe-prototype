...
function getAutoWidthClass(content: React.ReactNode) {
...
function TooltipRich({
  ...
  return (
    <span ref={rootRef} className={cn('inline-block', triggerClassName)}>
      <Tooltip
        open={isClickTrigger ? open : undefined}
        onOpenChange={isClickTrigger ? setOpen : undefined}
      >
        <TooltipTrigger
          onClick={
            isClickTrigger
        ...
        <TooltipContent
          ...
          alignOffset={alignOffset}
          className={cn(
            autoWidth ? getAutoWidthClass(content) : 'max-w-xs',
            contentClassName,
          )}
        >
          {content}
...
export { Tooltip, TooltipContent, TooltipProvider, TooltipRich, TooltipTrigger }
